...
def download_images(book_folder: str):
    ...
    try:
        ...
        # Use Claude Code MCP functions directly since we're in the Claude Code environment
        console.print(f"[yellow]Checking TODOIT lists and properties...[/yellow]")
        
        # This will be handled by calling MCP functions directly
        console.print("[blue]Please wait while we connect to TODOIT MCP service...[/blue]")
        return True  # For now, return success to test the basic structure
        ...
        with Progress(
            ...
            while True:
                ...
                try:
                    ...
                    try:
                        thread_id_prop = call_mcp_function(
...
def download_from_chatgpt(project_id: str, thread_id: str, scene_key: str, book_folder: str):
    ...
    try:
        ...
        # Navigate to the chat using Playwright headless MCP
        call_mcp_function("mcp__playwright-headless__browser_navigate", url=chat_url)
        call_mcp_function("mcp__playwright-headless__browser_snapshot")
        
        # Wait for page to load
        call_mcp_function("mcp__playwright-headless__browser_wait_for", time=3)
        ...
        try:
            ...
            click_result = call_mcp_function(
        ...
        # Close browser
        call_mcp_function("mcp__playwright-headless__browser_close")
