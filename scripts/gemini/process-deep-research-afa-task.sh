...
# Example: ./process-deep-research-afa-task.sh
# Example: ./process-deep-research-afa-task.sh --headless=false
...
if [ "$SUCCESS" == "true" ]; then
  SCREENSHOT="/tmp/gemini-deep-research-afa-final-success-*.png"
else
  SCREENSHOT="/tmp/gemini-deep-research-afa-error-*.png"
fi
