...
# ---
# Skrypt do pobierania obrazów dla serii książek przy użyciu TODOIT i narzędzia Claude.
#
...
BOOK_START_RANGE="135"      # Początek zakresu (np. 33 dla 0033_xxx)
BOOK_END_RANGE="147"        # Koniec zakresu (np. 44 dla 0044_xxx)
