# SYSTEM WYBORU FORMATU AUDIO DLA KSIĄŻKI v2.0 — wersja generyczna
...
**E. POLSKI KONTEKST** (`local_context`)
...
- Zaskakujące, nieoczywiste, rzadko omawiane
